...
insert into Bank_Inventory values('PayCard',2,300.45,8000.87,9000.56),('PayPoint',4,200.89,7000.67,6700.56);
...
select char_length(Geo_Location) 
from Bank_Inventory 
...
alter table Bank_Inventory 
modify Product varchar(6);       # No it is not possible to change the size of the attribute.
...
values(current_date(),current_date(),utc_timestamp());
